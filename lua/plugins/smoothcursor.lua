return {
  {
    ...
    config = function()
      require("smoothcursor").setup {
        ...
        disabled_filetypes = { "TelescopePrompt", "NvimTree", "FineCmdlinePrompt", "" }, -- Disable for these file types, ignored if enabled_filetypes is set. e.g., { "TelescopePrompt", "NvimTree" }
