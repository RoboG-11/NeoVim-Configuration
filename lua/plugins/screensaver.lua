return {
  ...
  config = function()
    require("drop").setup({
      ...
      screensaver = 1000 * 60 * 1,                -- show after x minutes. Set to false, to disable
      filetypes = { "dashboard", "ministarter" }, -- will enable/disable automatically for the following filetypes
